...
export default async function ForCustomersPage() {
  const t = await getTranslations('ForCustomers');

  const steps = [
    { icon: ShoppingBag, title: t('step1Title'), body: t('step1Body') },
    { icon: Calendar, title: t('step2Title'), body: t('step2Body') },
    { icon: Clock, title: t('step3Title'), body: t('step3Body') },
    { icon: Percent, title: t('step4Title'), body: t('step4Body') },
  ];

  const benefits = [
    { icon: Percent, title: t('benefit1Title'), body: t('benefit1Body') },
    { icon: Clock, title: t('benefit2Title'), body: t('benefit2Body') },
    { icon: ThumbsUp, title: t('benefit3Title'), body: t('benefit3Body') },
    ...
    <div className="min-h-screen bg-brand-stone">
      ...
      <section className="max-w-4xl mx-auto px-4 py-16 sm:py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/" className="bg-brand-ink hover:bg-brand-golddeep text-white px-8 py-3 rounded-lg font-serif font-semibold transition-colors">
            {t('findStore')}
          </Link>
      ...
      <section className="max-w-3xl mx-auto px-4 py-16 text-center">
        ...
        <Link href="/" className="bg-brand-ink hover:bg-brand-golddeep text-white px-10 py-4 rounded-lg font-serif font-semibold text-lg transition-colors inline-block">
          {t('findStoreCta')}
        </Link>
      </section>
